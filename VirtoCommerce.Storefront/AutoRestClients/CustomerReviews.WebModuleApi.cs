...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi
{
    ...
    public partial class CustomerReviews : IServiceOperations<CustomerReviewsWebRESTAPIdocumentation>, ICustomerReviews
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<string>> GetProductRatingWithHttpMessagesAsync(string productId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (productId == null)
            {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/customerReviews/rating").ToString();
            List<string> _queryParameters = new List<string>();
            if (productId != null)
            {
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi
{
    ...
    public partial interface ICustomerReviews
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<string>> GetProductRatingWithHttpMessagesAsync(string productId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='criteria'>
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi
{
    ...
    public static partial class CustomerReviewsExtensions
    {
            ...
            /// <param name='productId'>
            /// </param>
            public static string GetProductRating(this ICustomerReviews operations, string productId)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<string> GetProductRatingAsync(this ICustomerReviews operations, string productId, CancellationToken cancellationToken = default(CancellationToken))
            {
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi.Models
{
    ...
    public partial class CustomerReview
    {
        ...
        /// Initializes a new instance of the CustomerReview class.
        /// </summary>
        public CustomerReview(string authorNickname = default(string), string content = default(string), bool? isActive = default(bool?), string productId = default(string), double? rating = default(double?), System.DateTime? createdDate = default(System.DateTime?), System.DateTime? modifiedDate = default(System.DateTime?), string createdBy = default(string), string modifiedBy = default(string), string id = default(string))
        {
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi.Models
{
    ...
    public partial class CustomerReviewSearchCriteria
    {
        ...
        /// class.
        /// </summary>
        public CustomerReviewSearchCriteria(bool? isActive = default(bool?), IList<string> productIds = default(IList<string>), string responseGroup = default(string), string objectType = default(string), IList<string> objectTypes = default(IList<string>), IList<string> objectIds = default(IList<string>), string searchPhrase = default(string), string languageCode = default(string), string sort = default(string), IList<SortInfo> sortInfos = default(IList<SortInfo>), int? skip = default(int?), int? take = default(int?))
        {
            IsActive = isActive;
